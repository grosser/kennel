...
describe Kennel do
  ...
  before do
    engine = Kennel.send(:default_instance)
    engine.instance_variable_set(:@generated, nil)
    engine.instance_variable_set(:@api, nil)
    engine.instance_variable_set(:@syncer, nil)
